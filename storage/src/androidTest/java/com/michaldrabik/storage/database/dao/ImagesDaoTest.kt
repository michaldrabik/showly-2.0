...
class ImagesDaoTest : BaseDaoTest() {
  ...
  private val image1 = Image(1, 1, "poster", "show", "url", "thumbUrl", "tmdb")
  private val image2 = Image(2, 2, "poster", "episode", "url", "thumbUrl", "tmdb")
  private val image3 = Image(3, 1, "fanart", "show", "url", "thumbUrl", "tmdb")
  private val image4 = Image(4, 2, "fanart", "episode", "url", "thumbUrl", "tmdb")
  ...
  fun shouldUpsertShowImage() = runBlocking {
    ...
    val image = Image(10, 10, "fanart", "show", "url", "thumbUrl", "tmdb")
    ...
    val image2 = Image(10, 10, "fanart", "show", "url2", "thumbUrl2", "tmdb")
  ...
  fun shouldUpsertEpisodeImage() = runBlocking {
    ...
    val image = Image(10, 10, "fanart", "episode", "url", "thumbUrl", "tmdb")
    database.imagesDao().insertEpisodeImage(image)

    val result2 = database.imagesDao().getByEpisodeId(10, "fanart")
    assertThat(result2).isEqualTo(image)

    val image2 = Image(10, 10, "fanart", "episode", "url2", "thumbUrl2", "tmdb")
