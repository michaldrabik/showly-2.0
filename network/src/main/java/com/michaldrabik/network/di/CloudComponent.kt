...
import com.michaldrabik.network.di.module.RetrofitConvertersModule
...
@CloudScope
@Component(modules = [RetrofitModule::class, RetrofitConvertersModule::class, TraktModule::class, TvdbModule::class])
