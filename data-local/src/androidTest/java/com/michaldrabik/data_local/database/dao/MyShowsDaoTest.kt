...
class MyShowsDaoTest : BaseDaoTest() {
  ...
  fun shouldInsertAndStoreEntities() {
    runBlocking {
      val myShow = MyShow.fromTraktId(shows[0].idTrakt, 0)
  ...
  fun shouldReturnIdsOnly() {
    runBlocking {
      val myShow1 = MyShow.fromTraktId(shows[0].idTrakt, 0)
      val myShow2 = MyShow.fromTraktId(shows[1].idTrakt, 0)
  ...
  fun shouldDeleteByIdWithoutDeletingParent() {
    runBlocking {
      val myShow1 = MyShow.fromTraktId(shows[1].idTrakt, 0)
