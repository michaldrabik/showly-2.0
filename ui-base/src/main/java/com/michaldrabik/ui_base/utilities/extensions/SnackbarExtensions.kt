...
fun ViewGroup.showInfoSnackbar(message: String, actionText: Int = R.string.textOk, length: Int = LENGTH_SHORT) {
  showSnackbar(message, actionText, Color.BLACK, R.drawable.bg_snackbar_info, length)
}
